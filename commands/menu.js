...
const menu = (sender, client) => {
  ...
  client.sendMessage(sender, getWelcomeMessage());
  client.sendMessage(sender, getBotGPTMessage());
  client.sendMessage(sender, getImageMessage());
  client.sendMessage(sender, getStickerMessage());
  client.sendMessage(sender, getCalcMessage());
  client.sendMessage(sender, getVariantMessage());
